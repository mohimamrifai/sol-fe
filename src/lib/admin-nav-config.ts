...
export const ADMIN_NAV_GROUPS: AdminNavGroupDef[] = [
  ...
  },
  {
    groupKey: "operations",
    items: [
      { menuKey: "pickup", url: "/dashboard/admin/operations/pickup", icon: Package, requiredPermission: "view_operations", roles: ["super_admin", "operations"], status: "placeholder", fsdRef: "Operations/pick-up.md" },
      { menuKey: "gateInOrigin", url: "/dashboard/admin/operations/gate-in-origin", icon: DoorOpen, requiredPermission: "view_operations", roles: ["super_admin", "operations"], status: "placeholder", fsdRef: "Operations/gate-in-origin.md" },
      { menuKey: "loading", url: "/dashboard/admin/operations/loading", icon: Upload, requiredPermission: "view_operations", roles: ["super_admin", "operations"], status: "placeholder", fsdRef: "Operations/loading.md" },
      { menuKey: "trainDeparture", url: "/dashboard/admin/operations/train-departure", icon: LogOut, requiredPermission: "view_operations", roles: ["super_admin", "operations"], status: "placeholder", fsdRef: "Operations/train-departure.md" },
      { menuKey: "trainArrival", url: "/dashboard/admin/operations/train-arrival", icon: Train, requiredPermission: "view_operations", roles: ["super_admin", "operations"], status: "placeholder", fsdRef: "Operations/train-arrival.md" },
      { menuKey: "gateOutDestination", url: "/dashboard/admin/operations/gate-out-destination", icon: MapPinned, requiredPermission: "view_operations", roles: ["super_admin", "operations"], status: "placeholder", fsdRef: "Operations/get-out-destionation.md" },
      { menuKey: "delivery", url: "/dashboard/admin/operations/delivery", icon: Truck, requiredPermission: "view_operations", roles: ["super_admin", "operations"], status: "placeholder", fsdRef: "Operations/delivery.md" },
      { menuKey: "proofOfDelivery", url: "/dashboard/admin/operations/proof-of-delivery", icon: FileCheck, requiredPermission: "view_operations", roles: ["super_admin", "operations"], status: "placeholder", fsdRef: "Operations/proof-of-delivery.md" },
    ],
  },
  {
    groupKey: "masterData",
    items: [
      { menuKey: "route", url: "/dashboard/admin/master/route", icon: Route, requiredPermission: "manage_master_data", roles: ["super_admin", "operations"], status: "placeholder", fsdRef: "Master Data/route.md" },
      { menuKey: "station", url: "/dashboard/admin/master/station", icon: MapPin, requiredPermission: "manage_master_data", roles: ["super_admin", "operations"], status: "placeholder", fsdRef: "Master Data/station.md" },
      { menuKey: "yard", url: "/dashboard/admin/master/yard", icon: Warehouse, requiredPermission: "manage_master_data", roles: ["super_admin", "operations"], status: "placeholder", fsdRef: "Master Data/yard.md" },
      ...
      { menuKey: "additionalCharge", url: "/dashboard/admin/master/additional-charge", icon: PackagePlus, requiredPermission: "manage_master_data", roles: ["super_admin", "operations"], status: "placeholder", fsdRef: "Master Data/additional-charge.md" },
      { menuKey: "customerPricing", url: "/dashboard/admin/master/customer-pricing", icon: DollarSign, requiredPermission: "manage_pricing", roles: ["super_admin", "sales"], status: "placeholder", fsdRef: "Master Data/customer-pricing.md" },
    ],
  },
  {
    groupKey: "reports",
    items: [
      { menuKey: "shipmentReport", url: "/dashboard/admin/reports/shipment", icon: BarChart3, requiredPermission: "view_reports", roles: ["super_admin", "operations", "finance"], status: "placeholder", fsdRef: "Reports/shipment-report.md" },
      { menuKey: "bookingReport", url: "/dashboard/admin/reports/booking", icon: BarChart3, requiredPermission: "view_reports", roles: ["super_admin", "operations", "finance"], status: "placeholder", fsdRef: "Reports/booking-report.md" },
      { menuKey: "customerInvoiceReport", url: "/dashboard/admin/reports/customer-invoice", icon: BarChart3, requiredPermission: "view_reports", roles: ["super_admin", "finance"], status: "placeholder", fsdRef: "Reports/customer-invoice-report.md" },
      { menuKey: "customerPaymentReport", url: "/dashboard/admin/reports/customer-payment", icon: BarChart3, requiredPermission: "view_reports", roles: ["super_admin", "finance"], status: "placeholder", fsdRef: "Reports/customer-payment-report.md" },
      { menuKey: "vendorInvoiceReport", url: "/dashboard/admin/reports/vendor-invoice", icon: BarChart3, requiredPermission: "view_reports", roles: ["super_admin", "finance"], status: "placeholder", fsdRef: "Reports/vendor-invoice-report.md" },
      { menuKey: "vendorPaymentReport", url: "/dashboard/admin/reports/vendor-payment", icon: BarChart3, requiredPermission: "view_reports", roles: ["super_admin", "finance"], status: "placeholder", fsdRef: "Reports/vendor-payment-report.md" },
      { menuKey: "containerReport", url: "/dashboard/admin/reports/container", icon: BarChart3, requiredPermission: "view_reports", roles: ["super_admin", "operations"], status: "placeholder", fsdRef: "Reports/container-report.md" },
    ],
  },
  {
    groupKey: "settings",
    items: [
      ...
      { menuKey: "companyProfile", url: "/dashboard/admin/settings/company-profile", icon: Building2, requiredPermission: "view_settings", roles: ["super_admin"], status: "placeholder", fsdRef: "Settings/company-profile.md" },
      { menuKey: "numberingFormat", url: "/dashboard/admin/settings/numbering-format", icon: Hash, requiredPermission: "manage_numbering", roles: ["super_admin"], status: "placeholder", fsdRef: "Settings/numbering-format.md" },
      { menuKey: "systemConfiguration", url: "/dashboard/admin/settings/system-configuration", icon: SlidersHorizontal, requiredPermission: "manage_system_config", roles: ["super_admin"], status: "placeholder", fsdRef: "Settings/system-configuration.md" },
    ],
  },
];
