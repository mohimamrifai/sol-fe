...
import { useVendorJobOrderStats } from "@/hooks/use-vendor-job-orders";

const STATS = [
  { key: "pending_acceptance", icon: Clock, tone: "amber" },
  { key: "accepted", icon: CheckCircle2, tone: "blue" },
...
export function VendorJobOrdersStatsCards() {
  const t = useTranslations("Vendor.jobOrders.stats");
  const { data, isLoading } = useVendorJobOrderStats();
